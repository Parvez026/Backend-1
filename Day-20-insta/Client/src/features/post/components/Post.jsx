...
const Post = ({post,user,handelLike,handelUnLike}) => {
  return (
    <div className="post">
      <div className="user">
        <div className="img-wraper">
          <img
            src="https://plus.unsplash.com/premium_photo-1787108316103-39ebc615b19d?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxMXx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
        </div>
        <p>{user.username}</p>
      ...
      <div className="icons">
        <div className="left">
          <button>
            <svg
             className={post.isLike?"like":""}
             onClick={()=>{post.isLike?handelUnLike(post._id):handelLike(post._id)}}
